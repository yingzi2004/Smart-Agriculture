...
$tplDir = Join-Path $root "ruoyi-admin\src\main\resources\templates"
$staticDir = Join-Path $root "ruoyi-admin\src\main\resources\static\agriculture"

function New-AgPage($title, $page) {
@"
<!DOCTYPE html>
<html lang="zh">
<head>
    ...
    <link href="/agriculture/demo.css" rel="stylesheet">
</head>
<body data-page="$page">
    <div id="app" class="ag-page"></div>
    <script src="/ajax/libs/report/echarts/echarts-all.min.js"></script>
    <script src="/agriculture/demo.js?v=20260710-langchain"></script>
</body>
</html>
"@
}
...
$pages = @(
    @{ File = "dashboard.html"; Title = "智能总览"; Page = "dashboard" },
    @{ File = "greenhouses.html"; Title = "大棚管理"; Page = "greenhouses" },
    @{ File = "devices.html"; Title = "设备监测"; Page = "devices" },
    @{ File = "crops.html"; Title = "作物批次"; Page = "crops" },
    @{ File = "environment.html"; Title = "环境监测"; Page = "environment" },
    @{ File = "ai.html"; Title = "LangChain 中枢"; Page = "ai" },
    @{ File = "knowledge.html"; Title = "农业知识库"; Page = "knowledge" },
    @{ File = "alarms.html"; Title = "告警工单"; Page = "alarms" },
    @{ File = "disease.html"; Title = "病虫害诊断"; Page = "disease" },
    @{ File = "trace.html"; Title = "溯源管理"; Page = "trace" },
    @{ File = "community.html"; Title = "社区共创"; Page = "community" },
    @{ File = "visualization.html"; Title = "数据大屏"; Page = "visualization" }
)

foreach ($page in $pages) {
    [System.IO.File]::WriteAllText((Join-Path $staticDir $page.File), (New-AgPage $page.Title $page.Page), $utf8)
}

$menuHtml = @'
                <li>
                    <a class="menuItem" th:href="@{/agriculture/dashboard.html}"><i class="fa fa-dashboard"></i> <span class="nav-label">智能总览</span> </a>
                </li>
                <li th:each="menu : ${menus}" th:if="${false}">
'@

$indexPath = Join-Path $tplDir "index.html"
$index = [System.IO.File]::ReadAllText($indexPath, [System.Text.Encoding]::UTF8)
$index = [regex]::Replace($index, '(?s)\s*<li>\s*<a class="menuItem" th:href="@\{/agriculture/dashboard\.html\}".*?</li>\s*<li th:each="menu : \$\{menus\}" th:if="\$\{false\}">', "`r`n$menuHtml")
$customMenu = @'
                <li>
                    <a class="menuItem" th:href="@{/agriculture/greenhouses.html}"><i class="fa fa-home"></i> <span class="nav-label">大棚管理</span> </a>
                </li>
                <li>
                    <a class="menuItem" th:href="@{/agriculture/devices.html}"><i class="fa fa-microchip"></i> <span class="nav-label">设备监测</span> </a>
                </li>
                <li>
                    <a class="menuItem" th:href="@{/agriculture/crops.html}"><i class="fa fa-leaf"></i> <span class="nav-label">作物批次</span> </a>
                </li>
                <li>
                    <a class="menuItem" th:href="@{/agriculture/environment.html}"><i class="fa fa-line-chart"></i> <span class="nav-label">环境监测</span> </a>
                </li>
                <li>
                    <a class="menuItem" th:href="@{/agriculture/ai.html}"><i class="fa fa-sitemap"></i> <span class="nav-label">LangChain 中枢</span> </a>
                </li>
                <li>
                    <a class="menuItem" th:href="@{/agriculture/knowledge.html}"><i class="fa fa-book"></i> <span class="nav-label">农业知识库</span> </a>
                </li>
                <li>
                    <a class="menuItem" th:href="@{/agriculture/alarms.html}"><i class="fa fa-wrench"></i> <span class="nav-label">告警工单</span> </a>
                </li>
                <li>
                    <a class="menuItem" th:href="@{/agriculture/disease.html}"><i class="fa fa-bug"></i> <span class="nav-label">病虫害诊断</span> </a>
                </li>
                <li>
                    <a class="menuItem" th:href="@{/agriculture/trace.html}"><i class="fa fa-qrcode"></i> <span class="nav-label">溯源管理</span> </a>
                </li>
                <li>
                    <a class="menuItem" th:href="@{/agriculture/community.html}"><i class="fa fa-comments"></i> <span class="nav-label">社区共创</span> </a>
                </li>
                <li>
                    <a class="menuItem" th:href="@{/agriculture/visualization.html}"><i class="fa fa-area-chart"></i> <span class="nav-label">数据大屏</span> </a>
                </li>
'@
$index = [regex]::Replace($index, '(?s)\s*<li>\s*<a class="menuItem" th:href="@\{/agriculture/crops\.html\}".*?<li th:if="\$\{false\}">', "`r`n$customMenu`r`n                <li th:if=""`${false}"">")
[System.IO.File]::WriteAllText($indexPath, $index, $utf8)

$topnavPath = Join-Path $tplDir "index-topnav.html"
$topnav = [System.IO.File]::ReadAllText($topnavPath, [System.Text.Encoding]::UTF8)
$topnavMenu = @'
                <li><a class="menuItem" th:href="@{/agriculture/dashboard.html}"><i class="fa fa-dashboard"></i> <span class="nav-label">智能总览</span></a></li>
                <li><a class="menuItem" th:href="@{/agriculture/greenhouses.html}"><i class="fa fa-home"></i> <span class="nav-label">大棚管理</span></a></li>
                <li><a class="menuItem" th:href="@{/agriculture/devices.html}"><i class="fa fa-microchip"></i> <span class="nav-label">设备监测</span></a></li>
                <li><a class="menuItem" th:href="@{/agriculture/crops.html}"><i class="fa fa-leaf"></i> <span class="nav-label">作物批次</span></a></li>
                <li><a class="menuItem" th:href="@{/agriculture/environment.html}"><i class="fa fa-line-chart"></i> <span class="nav-label">环境监测</span></a></li>
                <li><a class="menuItem" th:href="@{/agriculture/ai.html}"><i class="fa fa-sitemap"></i> <span class="nav-label">LangChain 中枢</span></a></li>
                <li><a class="menuItem" th:href="@{/agriculture/knowledge.html}"><i class="fa fa-book"></i> <span class="nav-label">农业知识库</span></a></li>
                <li><a class="menuItem" th:href="@{/agriculture/alarms.html}"><i class="fa fa-wrench"></i> <span class="nav-label">告警工单</span></a></li>
                <li><a class="menuItem" th:href="@{/agriculture/disease.html}"><i class="fa fa-bug"></i> <span class="nav-label">病虫害诊断</span></a></li>
                <li><a class="menuItem" th:href="@{/agriculture/trace.html}"><i class="fa fa-qrcode"></i> <span class="nav-label">溯源管理</span></a></li>
                <li><a class="menuItem" th:href="@{/agriculture/community.html}"><i class="fa fa-comments"></i> <span class="nav-label">社区共创</span></a></li>
                <li><a class="menuItem" th:href="@{/agriculture/visualization.html}"><i class="fa fa-area-chart"></i> <span class="nav-label">数据大屏</span></a></li>
'@
$topnav = [regex]::Replace($topnav, '(?s)<div class="tab-pane fade height-full" id="index">\s*<ul class="nav">.*?</ul>\s*</div>', "<div class=""tab-pane fade height-full"" id=""index"">`r`n              <ul class=""nav"">`r`n$topnavMenu              </ul>`r`n            </div>")
[System.IO.File]::WriteAllText($topnavPath, $topnav, $utf8)
...
'@
[System.IO.File]::WriteAllText((Join-Path $staticDir "demo.js"), $demoJs, $utf8)

$cssPath = Join-Path $staticDir "demo.css"
$css = [System.IO.File]::ReadAllText($cssPath, [System.Text.Encoding]::UTF8)
if (-not $css.Contains(".flow")) {
    $css += @'
...
Write-Output "reworked langchain greenhouse demo"
