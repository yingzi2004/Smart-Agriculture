create database if not exists smart_agriculture_demo default character set utf8mb4 collate utf8mb4_general_ci;
use smart_agriculture_demo;
...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '智慧农业项目组',   0, '项目组长', '15888888888', 'smart@demo.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '软件开发组', 1, '项目组长', '15888888888', 'smart@demo.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '测试展示组', 2, '项目组长', '15888888888', 'smart@demo.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '后端接口组',   1, '项目组长', '15888888888', 'smart@demo.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '前端页面组',   2, '项目组长', '15888888888', 'smart@demo.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '测试联调组',   3, '项目组长', '15888888888', 'smart@demo.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '资料文档组',   4, '项目组长', '15888888888', 'smart@demo.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '部署运维组',   5, '项目组长', '15888888888', 'smart@demo.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '演示准备组',   1, '项目组长', '15888888888', 'smart@demo.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '答辩材料组',   2, '项目组长', '15888888888', 'smart@demo.com', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '智慧农业管理员', '00', 'smart@demo.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', null, null, 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,  105, 'ry',    '智慧农业测试员', '00', 'test@demo.com',  '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '0', '127.0.0.1', null, null, 'admin', sysdate(), '', null, '测试员');
...
insert into sys_menu values('4', '项目说明', '0', '4', '/system/main', '', 'C', '0', '1', '', 'fa fa-leaf', 'admin', sysdate(), '', null, '智慧农业项目说明');
-- 二级菜单
...
insert into sys_notice values('1', '智慧农业 Demo 已搭建', '2', '当前阶段只保留后端接口骨架，后续再扩展具体业务模块。', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '开发范围说明', '1', '本阶段暂不接入真实硬件，不开发完整业务功能，先完成若依基础框架改造和接口占位。', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('3', '智慧农业接口说明', '1', '<p>当前已提供占位接口：/agriculture/api/health、/agriculture/api/info、/agriculture/api/overview、/agriculture/api/modules。</p>', '0', 'admin', sysdate(), '', null, '管理员');
